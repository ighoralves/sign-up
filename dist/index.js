...
var getIndicator = function getIndicator(password, strengthValue) {
  for (var index = 0; index < password.length; index++) {
    var char = password.charCodeAt(index);
...
passwordInput.addEventListener("keyup", function () {
  ...
  var strengthText = getStrength(password);
  console.log(password);
  bars.classList = "";

  if (strengthText) {
    strengthDiv.innerText = "".concat(strengthText, " Password");
...
require("./main");
},{"./main":"javascript/main.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"C:\\MAMP\\htdocs\\signin-signup\\assets\\img\\bg-signin.jpg":[["bg-signin.6745ad87.jpg","img/bg-signin.jpg"],"img/bg-signin.jpg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"index.js":[function(require,module,exports) {
"use strict";
